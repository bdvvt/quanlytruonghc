     ...
     public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
         return http
                 ...
                 .authorizeHttpRequests(auth -> auth
                         ...
                         .requestMatchers(HttpMethod.PUT, "/api/users/*/role").hasAnyAuthority("ADMIN","SUPER_ADMIN")
                         .requestMatchers(HttpMethod.PUT, "/api/users/*/status").hasAnyAuthority("ADMIN","SUPER_ADMIN")
                         .requestMatchers(HttpMethod.PUT, "/api/users/*/password").hasAnyAuthority("ADMIN","STUDENT","SUPER_ADMIN")
